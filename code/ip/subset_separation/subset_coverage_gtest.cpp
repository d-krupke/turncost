...
TEST(IpSubset, DifficultConnectTest)
{
  ...
  //eliminate subtours
  turncostcover::ip_formulation1::SubsetCoverageSimpleSeparation s1{&solver, subset};
  turncostcover::ip_formulation1::SubsetSufficientSeparation s2{&solver, subset};
